...
public class AppoinmentBookingAdapter extends RecyclerView.Adapter<AppoinmentBookingAdapter.AppoinmentViewHolder> {
    ...
    public AppoinmentBookingAdapter(Context context, List<AppoinmentBookingPojo.TimeList> timeList, List<AppoinmentBookingPojo.BookedDates> bookedDatesList
            , String bookingdate
    ) {
    ...
    public void onBindViewHolder(final AppoinmentViewHolder holder, int position) {
       ...
       /* buttonList.add(holder.appinmentBookingBtn);
        ...
        String time = str;
        SimpleDateFormat dateFormat2 = new SimpleDateFormat("yyyy:MM:dd hh:mm aa", Locale.ENGLISH);
        try {
            ...
            SimpleDateFormat sdf12 = new SimpleDateFormat("dd/MM/yyyy", Locale.ENGLISH);
    ...
    class AppoinmentViewHolder extends RecyclerView.ViewHolder {
        ...
        public AppoinmentViewHolder(View itemView) {
            super(itemView);
            appinmentBookingBtn = itemView.findViewById(R.id.appinmentBookingBtn);
        }
    }

    private void setTimeNameChecker(Button btnTag) {
        for (int i = 0; i < buttonList.size(); i++) {
            if (!buttonList.get(i).getText().toString().equalsIgnoreCase(btnTag.getText().toString())) {
