...
public class DoctorReviewAdapter extends RecyclerView.Adapter<DoctorReviewAdapter.MyViewHolder> {
    ...
    ArrayList<NewDoctorProfile.Reviews> reviewsArrayList;
    Context context;

    public DoctorReviewAdapter(ArrayList<NewDoctorProfile.Reviews> reviewsArrayList, Context context) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, @SuppressLint("RecyclerView") final int position) {
        NewDoctorProfile.Reviews reviews = reviewsArrayList.get(position);
